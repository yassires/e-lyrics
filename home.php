    ...
    <section>
        <div class="flex-auto">
            ...
            <b class="flex flex-row text-gray-500 text-3xl">Welcome to the world of the music</b>
                    ...
                    <div div class="mt-5 p-4 gap-3">
                        <div div class="mt-5 grid lg:grid-cols-3 grid-cols-1  p-4 gap-3">
                            <div class="md:col-span-2 flex flex-col p-8 bg-white rounded shadow-sm">
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200 table-auto">
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            <div class="flex-shrink-0 h-16 w-16">
                                                                <img class="h-16 w-16" src="sng_img/dr dre.jpg" alt="" />
                                                            </div>
                                                            <div class="ml-4">
                                                                <div class="text-sm font-medium text-gray-900">The Next Episode</div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <span>
                                                            <div class="text-sm text-gray-500">Dr.Dre</div>
                                                        </span>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Rap</td>
                                                </tr>
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            <div class="flex-shrink-0 h-16 w-16">
                                                                <img class="h-16 w-16" src="sng_img/imagine dragons.jfif" alt="" />
                                                            </div>
                                                            <div class="ml-4">
                                                                <div class="text-sm font-medium text-gray-900">Mercury</div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <span>
                                                            <div class="text-sm text-gray-500">Imagine Dragons</div>
                                                        </span>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Alt-rock</td>
                                                </tr>
                            ...
                            <div class="flex flex-col p-5 bg-white rounded shadow-sm">
                                ...
                                <div class="p-4 ">
                                    <div class="md:col-span-2 flex flex-auto items-center justify-between p-5 bg-white rounded">
                                        <table class="min-w-full divide-y divide-gray-200 table-auto">
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            <div class="flex-shrink-0 h-12 w-12">
                                                                <img class="h-12 w-12 rounded-full" src="sng_img/dr dre_img.jpg" alt="" />
                                                            </div>
                                                            <div class="ml-4">
                                                                <div class="text-sm font-medium text-gray-900">Dr.dre</div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <span>
                                                            <div class="text-sm text-gray-500">Rappeur</div>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            <div class="flex-shrink-0 h-12 w-12">
                                                                <img class="h-12 w-12 rounded-full" src="sng_img/imagine dragons_img.jfif" alt="" />
                                                            </div>
                                                            <div class="ml-4">
                                                                <div class="text-sm font-medium text-gray-900">Imagine Dragons</div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <span>
                                                            <div class="text-sm text-gray-500">Alt-rock Band</div>
                                                        </span>
                                                    </td>
                                                </tr>
